-- ============================================================
-- ACTUALIZACIÓN MÍNIMA Y SEGURA - SISTEMA RP
-- Solo añade columnas esenciales sin crear referencias problemáticas
-- ============================================================
...
-- ============================================================
-- CREAR TABLAS NUEVAS SIN REFERENCIAS COMPLEJAS
-- ============================================================
...
SELECT 
    'Tabla Actualizada' as resultado,
    table_name,
    column_count
FROM information_schema.columns 
WHERE table_schema = 'public' 
    AND table_name IN ('cuentas_bancarias', 'servicio', 'bolo', 'items', 'sanciones')
GROUP BY table_name
ORDER BY table_name;
