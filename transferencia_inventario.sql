-- SISTEMA DE TRANSFERENCIA DE INVENTARIO ENTRE USUARIOS
...
-- 2. Función para transferir items de inventario
...
-- 3. Función para aceptar transferencia
...
-- 4. Función para rechazar transferencia
