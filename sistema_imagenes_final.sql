-- SISTEMA DE IMÁGENES PARA OBJETOS Y PERFILES (FINAL CORREGIDO)
...
-- 9. Insertar imágenes de ejemplo para productos (CORREGIDO - con UUID correcto)
INSERT INTO imagenes (nombre_archivo, url_original, tipo_contenido, categoria, servidor_id) 
SELECT 
    'telefono-movil.jpg', '/images/productos/telefono-movil.jpg', 'image/jpeg', 'producto', 'bbc123f4-c55a-4e6a-8a09-763aeebd50a1'::UUID
WHERE NOT EXISTS (SELECT 1 FROM imagenes WHERE nombre_archivo = 'telefono-movil.jpg' AND categoria = 'producto') UNION ALL
SELECT 
    'radio-policial.jpg', '/images/productos/radio-policial.jpg', 'image/jpeg', 'producto', 'bbc123f4-c55a-4e6a-8a09-763aeebd50a1'::UUID
WHERE NOT EXISTS (SELECT 1 FROM imagenes WHERE nombre_archivo = 'radio-policial.jpg' AND categoria = 'producto') UNION ALL
SELECT 
    'chaleco-antibalas.jpg', '/images/productos/chaleco-antibalas.jpg', 'image/jpeg', 'producto', 'bbc123f4-c55a-4e6a-8a09-763aeebd50a1'::UUID
WHERE NOT EXISTS (SELECT 1 FROM imagenes WHERE nombre_archivo = 'chaleco-antibalas.jpg' AND categoria = 'producto') UNION ALL
SELECT 
    'kit-medico.jpg', '/images/productos/kit-medico.jpg', 'image/jpeg', 'producto', 'bbc123f4-c55a-4e6a-8a09-763aeebd50a1'::UUID
WHERE NOT EXISTS (SELECT 1 FROM imagenes WHERE nombre_archivo = 'kit-medico.jpg' AND categoria = 'producto') UNION ALL
SELECT 
    'llaves-coche.jpg', '/images/productos/llaves-coche.jpg', 'image/jpeg', 'producto', 'bbc123f4-c55a-4e6a-8a09-763aeebd50a1'::UUID
WHERE NOT EXISTS (SELECT 1 FROM imagenes WHERE nombre_archivo = 'llaves-coche.jpg' AND categoria = 'producto') UNION ALL
SELECT 
    'gps-portatil.jpg', '/images/productos/gps-portatil.jpg', 'image/jpeg', 'producto', 'bbc123f4-c55a-4e6a-8a09-763aeebd50a1'::UUID
WHERE NOT EXISTS (SELECT 1 FROM imagenes WHERE nombre_archivo = 'gps-portatil.jpg' AND categoria = 'producto') UNION ALL
SELECT 
    'linterna-led.jpg', '/images/productos/linterna-led.jpg', 'image/jpeg', 'producto', 'bbc123f4-c55a-4e6a-8a09-763aeebd50a1'::UUID
WHERE NOT EXISTS (SELECT 1 FROM imagenes WHERE nombre_archivo = 'linterna-led.jpg' AND categoria = 'producto') UNION ALL
SELECT 
    'botiquin-basico.jpg', '/images/productos/botiquin-basico.jpg', 'image/jpeg', 'producto', 'bbc123f4-c55a-4e6a-8a09-763aeebd50a1'::UUID
WHERE NOT EXISTS (SELECT 1 FROM imagenes WHERE nombre_archivo = 'botiquin-basico.jpg' AND categoria = 'producto');

-- 10. Actualizar productos con sus imágenes (CORREGIDO - con UUIDs correctos)
UPDATE productos 
SET imagen_id = (
