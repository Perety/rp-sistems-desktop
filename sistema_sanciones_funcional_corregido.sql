-- SISTEMA DE SANCIONES FUNCIONAL COMPLETO (CORREGIDO)
...
-- 7. Crear sanciones de ejemplo funcionales (CORREGIDO - incluye campo tipo)
INSERT INTO sanciones (
    ...
    (
        ...
        'Admin User',
        'ban', -- <-- VALOR PARA CAMPO OBLIGATORIO
        'ban',
    ...
    (
        '4fb9fc1a-616c-4756-a0c0-ada4f6d3baf6',
        'Admin User',
        'mute', -- <-- VALOR PARA CAMPO OBLIGATORIO
        'mute',
        'Spam en el chat',
        'bbc123f4-c55a-4e6a-8a09-763aeebd50a1',
        'Admin System',
