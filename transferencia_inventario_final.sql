-- SISTEMA DE TRANSFERENCIA DE INVENTARIO ENTRE USUARIOS (FINAL CORREGIDO)
...
-- 2. Función para transferir items de inventario (FINAL CORREGIDA)
-- TODOS los parámetros obligatorios primero, luego los opcionales con defaults
CREATE OR REPLACE FUNCTION transferir_item_inventario(
    p_usuario_origen_id UUID,
...
-- 3. Función para aceptar transferencia (SIN CAMBIOS)
...
-- 4. Función para rechazar transferencia (SIN CAMBIOS)
