-- FIX: Eliminar foreign key y cambiar personaje_id de UUID a TEXT
DO $$
BEGIN
    -- Eliminar la foreign key si existe
    ALTER TABLE negocio_empleados DROP CONSTRAINT IF EXISTS negocio_empleados_personaje_id_fkey;
